    ...
    return (
        <div>
            ...
            <div className="container" style={{ position: "relative", zIndex: 2 }}>
                <div
                    className="cta-wrapper d-flex flex-column flex-lg-row align-items-center p-4 p-md-5"
                    style={{
                        borderRadius: "20px",
                ...
                >
                    ...
                    {/* Spacer */}
                    <div className="d-none d-lg-block" style={{ width: "240px", flexShrink: 0 }}></div>

                    {/* Heading */}
                    <h2
                        className="wow fadeInUp text-center text-lg-start mb-4 mb-lg-0"
                        data-wow-delay=".3s"
                        style={{
                    ...
                    {/* Button */}
                    <div
                        className="main-button wow fadeInUp text-center ms-lg-4"
                        data-wow-delay=".5s"
                        style={{ flexShrink: 0, position: "relative", zIndex: 11 }}
                    >
                        <Link href="/contact">
                            <span className="theme-btn" style={{ whiteSpace: "nowrap" }}>
            ...
            <section
                ...
                style={{ paddingTop: "150px", marginTop: "40px" }}
            >
